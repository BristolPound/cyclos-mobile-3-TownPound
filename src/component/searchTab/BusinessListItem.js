...
class BusinessListItem extends React.Component {
  ...
  render() {
    ...
    var image = this.props.business.image ? this.props.business.image.url : null

    return (
      <View style={container} ref="businessListItem">
          <View style={statusStyle}/>
          <View style={contents}>
              <ProfileImage image={image ? {uri: image} : undefined} style={styles.listItem.image} category={this.props.business.category || 'shop'} borderColor='offWhite' colorCode={colorCode}/>
              <View style={verticalStack}>
                  <DefaultText style={title}>{this.props.business.name}</DefaultText>
                  <DefaultText style={styles.listItem.shortDisplay}>{this.props.business.username || this.props.business.fields.username}</DefaultText>
              </View>
          </View>
