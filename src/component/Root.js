  ...
  render () {
      ...
      return (
        <View style={{flex: 1}}>
          ...
          {bodyComponent}
          <LoginOverlay/>
          {(this.props.modalOpen && !this.props.loginFormOpen) && Config.CURRENT_CONFIG.ALLOW_LOGIN && (this.props.userShortDisplay !== this.props.payeeShortDisplay) ? <SendMoney /> : undefined}
          <Login/>
          <StatusMessage/>
          {this.props.coverApp
